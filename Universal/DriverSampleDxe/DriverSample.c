...
//fanjix add 2022-11-24 begin ============================
        case 0x1232:
        {
          ...
          if (HiiGetBrowserData (&gDriverSampleFormSetGuid, VariableName, sizeof (DRIVER_SAMPLE_CONFIGURATION), (UINT8 *) Configuration)) 
          {
            DEBUG ((EFI_D_ERROR, "Configuration->TestLateCheck to[%d]\n", Configuration->TestLateCheck));
            if (Configuration->TestLateCheck == 0) 
                    Configuration->TestLateCheck2 = 1;
            if (Configuration->TestLateCheck == 1) 
                    Configuration->TestLateCheck2 = 0;
            HiiSetBrowserData (
              &gDriverSampleFormSetGuid,
              VariableName,
              sizeof (DRIVER_SAMPLE_CONFIGURATION),
        ...
        case 0x1233:
        {
          ...
          ASSERT (Configuration != NULL);
          if (HiiGetBrowserData (&gDriverSampleFormSetGuid, VariableName, sizeof (DRIVER_SAMPLE_CONFIGURATION), (UINT8 *) Configuration)) {
          DEBUG ((EFI_D_ERROR, "Configuration->TestLateCheck2 to[%d]\n", Configuration->TestLateCheck2));
          if (Configuration->TestLateCheck2 == 0) {
                  Configuration->TestLateCheck = 1;
          }
          if (Configuration->TestLateCheck2 == 1) {
                  Configuration->TestLateCheck = 0;
          }
          HiiSetBrowserData (
            &gDriverSampleFormSetGuid,
            VariableName,
