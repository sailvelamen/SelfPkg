  ...
  )
{
  ...
  ShellCommandRegisterCommandName (L"UpdateSpiFlash", ShellCommandRunUpdateSpiFlash, ShellCommandGetManFileNameLevel2, 2, L"", TRUE, gShellLevel2HiiHandle, STRING_TOKEN (STR_GET_HELP_UPDATESPIFLASH));
  //
